...
public:
	...
	void stop();
public:
	void loadingDataCallBack(const std::string &armatureName, bool result);
	virtual void setCameraMask(unsigned short mask, bool applyChildren = true);
private:
	void updateBaseColor();
	void setCameraMaskArmature(Armature* _armature, unsigned short mask, bool applyChildren);
protected:
